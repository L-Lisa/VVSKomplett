...
export default function ReliningPage() {
  const t = useTranslations('services.relining');
  ...
  const features = [
    {
      icon: CheckCircle,
      title: 'Modern teknik',
      description: 'Använder senaste relining-tekniken',
    },
    {
      icon: Clock,
      title: 'Snabb genomförande',
      description: 'Mindre störning än traditionell reparation',
    },
    {
      icon: Zap,
      title: 'Långsiktig lösning',
      description: 'Hållbar lösning som varar i många år',
    },
  ];
