...
import { Settings, CheckCircle, Clock, Shield } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Planerat underhåll för optimal prestanda',
    },
    {
      icon: Clock,
      title: 'Snabb respons',
      description: 'Akuta reparationer hanteras snabbt',
    },
    {
      icon: Shield,
      title: 'Förebyggande',
      description: 'Vi förhindrar problem innan de uppstår',
    },
  ];
