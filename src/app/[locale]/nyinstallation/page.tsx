...
export default function NewInstallationPage() {
  const t = useTranslations('services.newInstallation');
  ...
  const features = [
    {
      ...
      description: 'Vi följer alla branschstandarder och säkerhetsregler',
    },
    {
      icon: Clock,
      title: 'Snabb leverans',
      description: 'Effektiv planering och snabb genomförande',
    },
    {
      icon: Shield,
      title: 'Garanti',
      description: 'Fullständig garanti på alla våra installationer',
    },
  ];
