...
import { Home, CheckCircle, Clock, Shield } from 'lucide-react';

export default function PipeReplacementPage() {
  const t = useTranslations('services.pipeReplacement');
  const tNav = useTranslations('navigation');

  const features = [
    {
      icon: CheckCircle,
      title: 'Komplett stambyte',
      description: 'Vi byter hela rörsystemet från grunden',
    },
    {
      icon: Clock,
      title: 'Minimal störning',
      description: 'Planerad genomförande med minimal påverkan',
    },
    {
      icon: Shield,
      title: 'Lång garanti',
      description: 'Upp till 10 års garanti på våra arbeten',
    },
  ];
